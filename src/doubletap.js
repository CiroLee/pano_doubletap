...
var krpanoplugin= function(){
	...
	local.registerplugin = function(krpanointerface, pluginpath, pluginobject){
		...
		if(krpano.get("device.desktop")){
			console.log('desktop');
			plugin.registerattribute("ondbltap", "", function(krpano) {g = krpano}, function() {return g }), krpano.control.layer.addEventListener("dblclick", d, !0);
		}
		else if(krpano.get("device.ios") || krpano.get("device.android")){
			console.log('mobile');
